...
**目標**：新增「開團紀錄」模組，讓球團可在每場球局結束後完整記錄一場的營運數字，並一鍵算出當場利潤。
...
| 球團負責人 | 登入同一 group 帳號，輸入 club PIN 後操作自己 club 的活動與收費 |
...
1. 球館管理員點選「新增球團」
2. 填寫：**球團名稱**、**隊長 / 負責人姓名**、**PIN 碼**（三欄均必填）
